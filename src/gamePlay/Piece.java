...
class bishop extends Piece {
    ...
    public bishop(boolean side, String pos, ChessBoard cb) {
        this.Board = cb;
        id = 3;
        this.ic = (side)? ChessBoardBASE.ic.white_bishop: ChessBoardBASE.ic.black_bishop;
        this.pieceSide = side;
        this.position = pos;
...
class pawn extends Piece {
    public pawn(boolean side, String pos, ChessBoard cb) {
        this.Board = cb;
        id = 6;
        this.ic = (side)? ChessBoardBASE.ic.white_pawn: ChessBoardBASE.ic.black_pawn;
        this.pieceSide = side;
        this.position = pos;
        cb.getButton(pos).setIcon(ic);
    }
...
class king extends Piece {
    public king(boolean side, String pos, ChessBoard cb) {
        this.Board = cb;
        id = 5;
        this.ic = (side)? ChessBoardBASE.ic.white_king: ChessBoardBASE.ic.black_king;
        this.pieceSide = side;
        this.position = pos;
        cb.getButton(pos).setIcon(ic);
        if(side){
...
class queen extends Piece {
    public queen(boolean side, String pos, ChessBoard cb) {
        this.Board = cb;
        id = 4;
        this.ic = (side)? ChessBoardBASE.ic.white_queen: ChessBoardBASE.ic.black_queen;
        this.pieceSide = side;
        this.position = pos;
        cb.getButton(pos).setIcon(ic);
    }
...
class rook extends Piece {
    public rook(boolean side, String pos, ChessBoard cb) {
        this.Board = cb;
        id = 1;
        this.ic = (side)? ChessBoardBASE.ic.white_rook: ChessBoardBASE.ic.black_rook;
        this.pieceSide = side;
        this.position = pos;
        cb.getButton(pos).setIcon(ic);
    }
...
class knight extends Piece {
    public knight(boolean side, String pos, ChessBoard cb) {
        this.Board = cb;
        id = 2;
        this.ic = (side)? ChessBoardBASE.ic.white_knight: ChessBoardBASE.ic.black_knight;
        this.pieceSide = side;
        this.position = pos;
        cb.getButton(pos).setIcon(ic);
    }
